...
-	The router forms a boundary between your local network and the internet, helping protect your devices from unwanted incoming traffic.
...
-	PC2 receives it and ignores it. 
-	PC3 receives it and accepts it. 
-	PC4 receives it and ignores it. 
...
-	Deliver the data packets to the correct port based on the destination address.

> 	In a summary hubs and switches are used to create networks while router connects different networks for communication.
>   When we divide a large area network (LAN), we create a subnetwork ,  The major advantages of subnetworks are , Help to reduce the network traffic , helps to organize different departments in a company , helps to improve the overall security.
-	The router is used to separate different subnets and it act as a gateway between different subnets.
-	LAN is a mainly a network of internal system , these are private network unlike WAN , which covers a wide area
